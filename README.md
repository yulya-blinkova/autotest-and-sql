Финальный проект 
Часть 2 
Задание 1. Список логинов курьеров с количеством их заказов в статусе «В доставке» (поле inDelivery = true). https://github.com/BulychevaAA/final_project/blob/main/2.png

Задание 2. Трекеры заказов и их статусы - https://github.com/BulychevaAA/final_project/blob/main/1.png
